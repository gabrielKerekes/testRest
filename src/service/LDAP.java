...
public class LDAP {
	...
	// todo: GABO - mohlo by sa nejak optimalizovat aby necital vzdy zo suboru
	...
	public LDAP(String username, String pass, String mail, String grid_card[], String init,String imei,String pin){
	...
	public LDAP(String username, String passwrd, String otp){
	...
	public LDAP(String username, String passwrd){
	...
	public LDAP(String username, String pass, String mail, String grid_card[], String pin){
	...
	private boolean otp_is_correct(){
		...
		try {
			OTP_window = OtpGenerator.generateOTP(otp_seed, otp_counter_i);
		} catch (IOException e) {
	...
	public boolean syncOtpCounter(int newOtpCounter) {
		return modify_attribute("employeenumber", Integer.toString(newOtpCounter), null);
	}
}
