...
public class LDAP {
	...
	private String readLdapIpFromConfigFile() {
		try {
			...
			// new
			// InputStreamReader(this.getClass().getResourceAsStream("/config/ldapIp.conf")));
	...
	private LDAPAttribute get_attribute(String attName) {
		// nacita userove grids a do premennych "code_num" a "code" da vybrane
		// hodnoty
